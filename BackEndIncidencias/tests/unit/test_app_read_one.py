...
from BackEndIncidencias.read_one_incidence.app import lambda_handler  # Ajusta el import según la ubicación del archivo
...
class TestLambdaHandler(unittest.TestCase):
    ...
    def test_lambda_handler_success(self, mock_connect):
        ...
        # Configurar el cursor para simular la eliminación de una fila
        mock_cursor.rowcount = 1  # Simula que una fila fue eliminada
    ...
    def test_lambda_handler_report_not_found(self, mock_connect):
        ...
        # Configurar el cursor para simular que no se eliminó ninguna fila
        mock_cursor.rowcount = 0  # Simula que no se eliminó ninguna fila
    ...
    def test_lambda_handler_database_error(self, mock_connect):
        # Configurar el mock para la conexión a la base de datos
        mock_connect.side_effect = MagicMock(side_effect=Exception('Test DB Error'))
    ...
    def test_lambda_handler_generic_error(self, mock_connect):
        # Configurar el mock para la conexión a la base de datos
        mock_connect.side_effect = Exception('Test Generic Error')
